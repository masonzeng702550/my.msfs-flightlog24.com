...
(function () {
  const T = {
    en: {
      ...
      records: "Records", total_block: "block time", total_air: "in the air",
      rec_longest: "Longest flight", rec_longest_time: "Longest time",
      rec_highest: "Highest cruise", rec_fastest: "Fastest ground speed",
      rec_smoothest: "Smoothest landing", rec_hardest: "Hardest landing",
      ...
      l_times: "Departure → arrival",
      group_aircraft: "Aircraft type", group_airport: "Airport",
      group_flights: "flights", group_airports: "airports", group_destinations: "destinations",
      group_span: "Span", group_first: "First flight", group_last: "Latest flight",
      group_missing: "Nothing selected", group_none: "No flights found",
    ...
    zh: {
      ...
      records: "個人紀錄", total_block: "總區塊時間", total_air: "空中時間",
      rec_longest: "最長航程", rec_longest_time: "最長飛行時間",
      rec_highest: "最高巡航", rec_fastest: "最快地速",
      rec_smoothest: "最柔順落地", rec_hardest: "最重落地",
      hours_per_month: "每月飛行時數",
      ...
      l_times: "起飛 → 抵達",
      group_aircraft: "機型", group_airport: "機場",
      group_flights: "趟", group_airports: "機場", group_destinations: "航點",
      group_span: "時間範圍", group_first: "首次飛行", group_last: "最近飛行",
      group_missing: "未指定項目", group_none: "沒有相關飛行紀錄",
    ...
    ja: {
      ...
      records: "自己記録", total_block: "ブロックタイム合計", total_air: "飛行時間",
      rec_longest: "最長距離", rec_longest_time: "最長飛行時間",
      rec_highest: "最高巡航高度", rec_fastest: "最大対地速度",
      rec_smoothest: "最も滑らかな着陸", rec_hardest: "最もハードな着陸",
      hours_per_month: "月別飛行時間",
      ...
      l_times: "出発 → 到着",
      group_aircraft: "機種", group_airport: "空港",
      group_flights: "フライト", group_airports: "空港", group_destinations: "就航地",
      group_span: "期間", group_first: "初回フライト", group_last: "最新フライト",
      group_missing: "未選択", group_none: "該当するフライトがありません",
    ...
    ko: {
      ...
      records: "개인 기록", total_block: "총 블록 시간", total_air: "공중 시간",
      rec_longest: "최장 거리", rec_longest_time: "최장 비행 시간",
      rec_highest: "최고 순항 고도", rec_fastest: "최대 대지속도",
      rec_smoothest: "가장 부드러운 착륙", rec_hardest: "가장 강한 착륙",
      hours_per_month: "월별 비행 시간",
      ...
      l_times: "출발 → 도착",
      group_aircraft: "기종", group_airport: "공항",
      group_flights: "편", group_airports: "공항", group_destinations: "취항지",
      group_span: "기간", group_first: "첫 비행", group_last: "최근 비행",
      group_missing: "선택 없음", group_none: "해당 비행이 없습니다",
